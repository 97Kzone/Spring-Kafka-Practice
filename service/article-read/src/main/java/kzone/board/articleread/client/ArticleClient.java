package kzone.board.articleread.client;
...
public class ArticleClient {
    ...
    public List<ArticleResponse> readAllInfiniteScroll(Long boardId, Long lasArticleId, Long pageSize) {
        try {
            return restClient.get()
                    .uri(
                            lasArticleId != null ?
                                    "/v1/articles/infinite-scroll?boardId=%s&lastArticleId=%s&pageSize=%s"
                                            .formatted(boardId, lasArticleId, pageSize) :
            ...
            log.error("[ArticleClient.readAllInfiniteScroll] boardId = {}, lastArticleId = {}, pageSize = {}", boardId, lasArticleId, pageSize, e);
            return List.of();
        }
    }
