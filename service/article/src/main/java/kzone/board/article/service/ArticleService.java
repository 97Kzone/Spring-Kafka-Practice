package kzone.board.article.service;

import jakarta.transaction.Transactional;
import kzone.board.article.entity.Article;
import kzone.board.article.entity.BoardArticleCount;
import kzone.board.article.repository.ArticleRepository;
import kzone.board.article.repository.BoardArticleCountRepository;
import kzone.board.article.service.request.ArticleCreateRequest;
import kzone.board.article.service.request.ArticleUpdateRequest;
    ...
    public ArticleResponse create(ArticleCreateRequest request) {
        ...
        outboxEventPublisher.publish(
                ...
                ArticleCreatedEventPayload.builder()
                        ...
                        .boardArticleCount(article.getBoardId())
                        .build(),
                article.getBoardId()
        );
