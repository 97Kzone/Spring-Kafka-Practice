package kzone.board.like.service;

import jakarta.transaction.Transactional;
import kzone.board.common.event.EventType;
import kzone.board.common.event.payload.ArticleLikedEventPayload;
import kzone.board.common.event.payload.ArticleUnlikedEventPayload;
import kzone.board.common.outboxmessagerelay.OutboxEventPublisher;
import kzone.board.common.snowflake.Snowflake;
import kzone.board.like.entity.ArticleLike;
import kzone.board.like.entity.ArticleLikeCount;
import kzone.board.like.repository.ArticleLikeCountRepository;
import kzone.board.like.repository.ArticleLikeRepository;
import kzone.board.like.service.response.ArticleLikeResponse;
...
public class ArticleLikeService {
    ...
    public void likePessimisticLock1(Long articleId, Long userId) {
        ...
        if (result == 0) {
            // 트래픽이 몰린다면 ? -> 게시글 생성 시 처리하는 방법도 OK
