...
import kzone.board.hotarticle.repository.HotArticleListRepository;
import kzone.board.hotarticle.service.eventhandler.EventHandler;
...
public class HotArticleScoreUpdater {
    ...
    private static boolean isArticleCreatedToday(LocalDateTime createdTime) {
